...
SUBJECT_KEYWORDS_MAP: Dict[str, List[str]] = {
    "金融科技综述": ["fintech", "financial technology", "金融科技"],
    "大模型综述": ["llm", "large language model", "大模型"],
    "金融科技大模型综述": ["fintech", "llm", "金融科技 大模型"],
    "移动端自动化大模型Agent": ["mobile automation", "agent", "mllm", "移动 自动化"],
    "其他": [],
}
